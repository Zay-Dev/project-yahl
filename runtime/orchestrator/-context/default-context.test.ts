...
import { seedDefaultContext, seedRunInputContext } from './default-context';
...
describe('seedRunInputContext', () => {
  it('seeds declared keys from runInput', () => {
    const storage = createStorage();

    seedRunInputContext(storage, { knowledge_topic: '  my-topic  ' }, ['knowledge_topic']);
  ...
  it('no-ops when runInputContextKeys is absent', () => {
    ...
    seedRunInputContext(storage, { knowledge_topic: 'my-topic' }, undefined);
