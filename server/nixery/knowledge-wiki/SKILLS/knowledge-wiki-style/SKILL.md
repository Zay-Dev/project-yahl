...
Submit atomic observations only when **worth persisting** (see `/opt/skills/worth-persisting-knowledge/SKILL.md`):

`/nixery(submit-knowledge-observation, cue: …, claim: …, example|quote: …, evidence: …, topic_hint?: …)`

See `/opt/skills/submit-knowledge-observation/SKILL.md`.
